...
def main(args):
    ...
    if args.mode == "axis":
        ...
        for i in range(n_achors):
            pl.add_mesh(pv.Cube(center=anchors[i], x_length=3e-3, y_length=3e-2, z_length=3e-3),
                        color="yellow",
                        name=f"anchor{i}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=str, choices=["axis", "anchor"], default="anchor", help="visualize axis or anchor")
